...
async def test_health_success_and_routes_are_exposed(
    ...
    assert [getattr(route, "path", None) for route in app.routes] == [
        ...
        "/invocations/{invocation_id}/events/stream",
        "/invocations/{invocation_id}/turns",
        "/invocations/{invocation_id}/cancel",
        "/invocations/{invocation_id}/fork",
        "/invocations/{invocation_id}/artifacts",
        "/invocations/{invocation_id}/artifacts/{artifact_id}",
        "/invocations/{invocation_id}/memory",
        "/invocations/{invocation_id}/recall",
        "/backfill",
        "/backfill",
